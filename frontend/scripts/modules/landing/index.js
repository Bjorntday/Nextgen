...
const i18n = {
  en: {
    ...
    desc: "No editing skills needed. NextGen extracts product highlights, plans the story, and outputs production-ready videos with a workflow your team can operate directly.",
    ...
    start: "Get started",
    creatorUsage: "10,000+ creators are using NextGen",
    creatorNum: "10,000+",
    creatorLabel: "creators are using NextGen",
  ...
  zh: {
    ...
    heroLine1: "上传商品图或链接，",
    heroLine2: "把想法直接变成视频。",
    desc: "无需剪辑技能，NextGen 会自动识别商品卖点、组织镜头表达，并以团队可直接使用的工作流，在几分钟内产出可投放的视频内容。",
    heroPoint1: "商品图驱动",
    heroPoint2: "商品链接解析",
    heroPoint3: "提示词增强生成",
    cta: "开始生成",
    ...
    placeholders: ["上传商品图，描述你的商品信息和想要的视频风格…", "告诉 NextGen 你想生成什么视频，或粘贴商品链接", "输入视频卖点、受众、风格等关键信息"],
    refPanelTitle: "选择参考图",
...
async function callLandingImageGenerate(promptText, _maxRetries = 2) {
  ...
  const brand_philosophy = style
    ...
    : "NextGen conversion-oriented product storytelling";
