...
export const i18n = {
  zh: {
    ...
    durationLabel: "视频时长",
    welcome:
      "Hi — 我是 NextGen 的 AI 助手 😊 你可以直接写提示词一键生成，或上传参考图让我自动识别并回填商品信息。\n还支持商品链接解析、AI 生图补图、首尾帧控制、并发任务（单页最多 {max} 个）以及生成后继续编辑视频/脚本。",
    ...
    hotVideoSummaryShotPlan: "分镜计划：{value}",
    ...
    hotVideoRetryGuide: "当前结果基于兜底模板，换用视频直链可获得更精准的拆解：",
  ...
  en: {
    ...
    hotVideoSummaryShotPlan: "Shot plan: {value}",
    ...
    hotVideoRetryGuide: "Result is based on the fallback template. Retry with a direct video link for a more accurate breakdown:",
